...
def parse_url():
    try:
        parse_ur = urllib.parse.urlparse('https://www.geeksforgeeks.org/python-urllib-module/')
        print(parse_ur)
        unparse_url = urllib.parse.urlunparse(parse_ur)
        print(unparse_url)

        split_url = urllib.parse.urlsplit('https://www.geeksforgeeks.org/python-urllib-module/')
        print(split_url)
