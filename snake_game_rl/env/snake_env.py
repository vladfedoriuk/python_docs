...
from snake_game_rl.settings.constants import SIZE
...
class SnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.alive = False if  not self.world.snake.alive else True
        # Perform the action
        ...
        return self.world.get_observation(), reward, done, np.array(snake)
